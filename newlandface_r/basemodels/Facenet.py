...
def loadModel(url = 'https://drive.google.com/uc?id=1971Xk5RwedbudGgTIrGAL4F7Aifu7id1'):#已解决
	...
	# home = str(Path.home())
	home = 'D:/newlandface'
	if os.path.isfile(home+'/weights/facenet_weights.h5') != True:
	...
	model.load_weights(home+'/weights/facenet_weights.h5')
